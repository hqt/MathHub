...
namespace ConsoleApp.Test.Problems
{
    ...
    public class CommentTest
    {
        ...
        public void TestGeneralComment()
        {
            ...
            // retrieve comment
            // Get All Comments
            IEnumerable<Comment> comments = problemQueryService.GetAllReplyComments(problem.Id, 0, 100);
            bool isExist = false;
            ...
            //test update
            comments = problemQueryService.GetAllReplyComments(problem.Id, 0, 100);
            isExist = false;
            foreach (Comment comment in comments)
            {
