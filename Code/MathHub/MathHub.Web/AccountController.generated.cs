...
namespace MathHub.Web.Controllers
{
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_AccountController : MathHub.Web.Controllers.AccountController
    {
        ...
        [NonAction]
        public override System.Web.Mvc.ActionResult Login(MathHub.Entity.Entity.LoginModel model, string returnUrl)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Login);
