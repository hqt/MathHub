...
namespace MathHub.Framework.Utils
{
    public static class WebUtils
    {
        ...
        public static virtual string GetUrlReferrer(HttpContextBase httpContext)
        {
        ...
        /// </summary>
        /// <returns>URL referrer</returns>
        public static virtual string GetCurrentIpAddress(HttpContextBase httpContext)
        {
        ...
        /// <returns>Page name</returns>
        //public virtual string GetThisPageUrl(HttpContextBase httpContext, bool includeQueryString, bool useSsl)
        //{
        ...
        public virtual bool IsCurrentConnectionSecured(HttpContextBase _httpContext)
        {
            bool useSsl = false;
        ...
        public virtual string ServerVariables(HttpContextBase _httpContext, string name)
        {
        ...
        public virtual string GetStoreHost(HttpContextBase _httpContext, bool useSsl)
        {
            var result = "";
        ...
        public virtual string GetStoreLocation(HttpContextBase _httpContext)
        {
            bool useSsl = IsCurrentConnectionSecured();
        ...
        /// <param name="useSsl">Use SSL</param>
        /// <returns>Store location</returns>
        //public virtual string GetStoreLocation(HttpContextBase _httpContext, bool useSsl)
        //{
        ...
        public virtual string MapPath(HttpContextBase _httpContext, string path)
        {
        ...
        //public virtual T QueryString<T>(HttpContextBase _httpContext, string name)
        //{
